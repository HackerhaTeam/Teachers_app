...
import 'package:teacher_hackerha/features/auth/presentation/widgets/fields/day_field.dart';
import 'package:teacher_hackerha/features/auth/presentation/widgets/fields/gender_sellector.dart';
import 'package:teacher_hackerha/features/auth/presentation/widgets/fields/month_field.dart';
import 'package:teacher_hackerha/features/auth/presentation/widgets/fields/year_field.dart';

class SignUpPage2Body extends StatefulWidget {
  const SignUpPage2Body({super.key, required this.onNext});

  final VoidCallback onNext;

  @override
  State<SignUpPage2Body> createState() => _SignUpPage4BodyState();
}

class _SignUpPage4BodyState extends State<SignUpPage2Body> {
