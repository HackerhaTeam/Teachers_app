...
import 'package:teacher_hackerha/features/auth/presentation/widgets/fields/email_field.dart';
import 'package:teacher_hackerha/features/auth/presentation/widgets/fields/password_field.dart';

class SignUpPage3Body extends StatefulWidget {
  const SignUpPage3Body({super.key, required this.onNext});

  final VoidCallback onNext;

  @override
  State<SignUpPage3Body> createState() => _SignUpPage5BodyState();
}

class _SignUpPage5BodyState extends State<SignUpPage3Body> {
