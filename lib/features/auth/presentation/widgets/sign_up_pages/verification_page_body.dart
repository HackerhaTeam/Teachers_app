...
import 'package:teacher_hackerha/core/widgets/custom_success_dialog.dart';
import 'package:teacher_hackerha/core/widgets/headers/introduction_header.dart';
import 'package:teacher_hackerha/features/auth/presentation/pages/log_in_pages/reset_password_page.dart';
import 'package:teacher_hackerha/features/auth/presentation/widgets/fields/pin_code_fields.dart';
...
class VerificationPageBody extends StatefulWidget {
  const VerificationPageBody({super.key, required this.isSignin});
        ...
        onNext: () async {
          if (formKey.currentState!.validate()) {
            if (widget.isSignin) {
              ...
              context.navigateWithSlideTransition(const MainNavigationPage());
            }
          }
        },
      ),
