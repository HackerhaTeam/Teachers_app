    ...
    return TabBar(
      ...
      tabs:
          widget.tabs
              .map(
                (tab) => Tab(
                  child: Padding(padding: EdgeInsets.zero, child: Text(tab)),
                ),
              )
              .toList(),
      indicator: UnderlineTabIndicator(
        borderSide: BorderSide(color: content.brandPrimary, width: 3.0),
      ...
      labelStyle: context.xLabelMedium.copyWith(letterSpacing: 0),
