...
import 'package:teacher_hackerha/core/widgets/list_tile_card_details.dart';
...
class ListTileCard extends StatelessWidget {
  const ListTileCard({
    ...
    required this.circleIconAsset,
    required this.childOfRoundedSquareShape,
  });
  final int index;
  final String title;
  final String subTitle;
  final Color? backgroundIconColor;
  final String circleIconAsset;
  final Widget childOfRoundedSquareShape;
  @override
        ...
        child: Row(
          children: [
            RoundedSquareShape(
              ...
              child: childOfRoundedSquareShape,
            ),
            SizedBox(width: 8.w(context)),
            ListTileCardDetails(title: title, subTitle: subTitle),
            Spacer(),
            CustomCircleIcon(
              circleSize: 16.w(context),
              iconColor: contentColor.primaryInverted,
              backgroundColor:
                  backgroundIconColor ?? backgroundColor.primaryBrand,
              iconAsset: circleIconAsset,
